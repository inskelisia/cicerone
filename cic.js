...
//here
  ...
  if(cmd === `${prefix}help`){
    ...
    .addField("Bot Name", bot.user.username)
    .addField("For Bot Information", `+botinfo`)
    .addField("For Server Information", `+serverinfo`)
    .addField("For Reporting Someone", `+report @Username#DiscordTag Reason`)
    .addField("To Kick Someone", `+kick @Username#DiscordTag Reason [For Mods only]`)
    .addField("To Ban Someone", `+ban @Username#DiscordTag Reason [For Mods only]`);
